describe('Jasmine', function() {
  ...
  describe('file handler', function() {
    ...
    it('add spec files with glob pattern', function() {
      ...
      expect(this.testJasmine.specFiles.map(basename)).toEqual(['command_spec.js', 'jasmine_spec.js', 'master_spec.js', 'run_spec.js', 'worker_spec.js']);
    });

    it('add spec files with excluded files', function() {
      expect(this.testJasmine.specFiles).toEqual([]);
      this.testJasmine.addSpecFiles(['spec/*.js', '!spec/command*']);
      expect(this.testJasmine.specFiles.map(basename)).toEqual(['jasmine_spec.js', 'master_spec.js', 'run_spec.js', 'worker_spec.js']);
    });
    ...
    it('add spec files with glob pattern to existings files', function() {
      ...
      this.testJasmine.addSpecFiles(['spec/*.js']);
      expect(this.testJasmine.specFiles.map(basename)).toEqual(['command_spec.js', 'b', 'jasmine_spec.js', 'master_spec.js', 'run_spec.js', 'worker_spec.js']);
    });
    ...
    it('add helper files with glob pattern to existings files', function() {
      ...
      expect(this.testJasmine.helperFiles.map(basename)).toEqual(['command_spec.js', 'b', 'jasmine_spec.js', 'master_spec.js', 'run_spec.js', 'worker_spec.js']);
    });
  });
