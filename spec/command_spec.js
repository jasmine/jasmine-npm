...
describe('command', function() {
  ...
  describe('running specs', function() {
    ...
    it('should be able to add one helper pattern', function() {
      ...
      expect(this.fakeJasmine.addHelperFiles).toHaveBeenCalledWith(['helpers/**/*.js'], true);
    });
    ...
    it('should be able to add many helper patterns', function() {
      ...
      expect(this.fakeJasmine.addHelperFiles).toHaveBeenCalledWith(['helpers/**/*.js', 'other.js'], true);
    });
