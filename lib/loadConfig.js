module.exports = exports = function(jasmine, env, print) {
  ...
  if (env.reporter !== undefined) {
    try {
      var Report = env.reporterConstructor !== undefined ? require(env.reporter)[env.reporterConstructor] : require(env.reporter);
      var reporter = env.reporterConfiguration !== undefined ? new Report(require(env.reporterConfiguration)) : new Report();
