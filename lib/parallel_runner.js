...
class ParallelRunner extends RunnerBase {
  ...
  async execute(files, filterString) {
    ...
    await this.reportDispatcher_.jasmineDone({
      overallStatus: this.overallStatus_(),
      totalTime: this.timer_.elapsed(),
      // TODO: include passed and failed expectations
      failedExpectations: [],
      passedExpectations: [],
    });
  }
