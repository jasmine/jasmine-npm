...
/**
 * @classdesc Configures, builds, and executes a Jasmine test suite in parallel.<br>See also {@link Runner} which defines key parts of this class's interface.
...
class ParallelRunner extends RunnerBase {
  constructor(options) {
      ...
      function(queueRunnerOptions) {
        queueRunnerOptions = {
          ...
          fail: function() {
            ...
            // or done(anError).
            // TODO: handle this the same way it would be handled in sequential mode
          },
          onException: function() {
            // An async reporter timed out, rejected the promise that it returned,
            // tried to use two forms of async, or caused an unhandled exception
            // or unhandled promise rejection.
            // TODO: handle this the same way it would be handled in sequential mode
          },
          deprecated: function() {
            // A reporter triggered a deprecation warning.
            // TODO: handle this the same way it would be handled in sequential mode
          }
        };
        new bootedCore.QueueRunner(queueRunnerOptions).execute();
      },
      function() {
     ...
     *
     * @name ParallelRunner#exitOnCompletion
     * @type {boolean}
     * @default true
     */
