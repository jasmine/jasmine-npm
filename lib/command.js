...
function installExamples(projectBaseDir, spec) {
  ...
  copyFiles(
    path.join(jasmine_core_examples, 'spec', 'helpers', 'jasmine_examples'),
    path.join(spec, 'helpers', 'jasmine_examples'),
    new RegExp(/[Hh]elper\.js/)
  );

  copyFiles(
    path.join(jasmine_core_examples, 'lib', 'jasmine_examples'),
    path.join(projectBaseDir, 'lib', 'jasmine_examples'),
    new RegExp(/\.js/)
  );

  copyFiles(
    path.join(jasmine_core_examples, 'spec', 'jasmine_examples'),
    path.join(spec, 'jasmine_examples'),
